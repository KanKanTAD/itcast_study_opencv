...
class PainterMoveActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PainterMoveFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PainterMoveFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PainterMoveActionFeedback(null);
    ...
    data.feedback = PainterMoveFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PainterMoveActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PainterMoveFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PainterMoveFeedback()
    }
...
module.exports = PainterMoveActionFeedback;
