...
class PainterMoveActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PainterMoveGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PainterMoveGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PainterMoveActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PainterMoveGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PainterMoveGoal()
    }
...
module.exports = PainterMoveActionGoal;
